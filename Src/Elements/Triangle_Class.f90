...
integer :: i
    ...
    ! Quadrature formula
    !--------------------------------------
    alpha_1 = 0.249286745170911d0
    beta_1  = 0.501426509658179d0
    e%x_q(1,:) = (/ alpha_1, beta_1, alpha_1 /)
    e%w_q(1)   =  0.116786275726379d0

    alpha_1 = 0.50142650965818d0
    beta_1  = 0.24928674517091d0
    e%x_q(2,:) = (/ alpha_1, beta_1, beta_1 /)
    e%w_q(2)   =  0.116786275726379d0
   
    alpha_1 = 0.249286745170911d0
    beta_1  = 0.501426509658179d0
    e%x_q(3,:) = (/ alpha_1, alpha_1, beta_1 /)
    e%w_q(3)   =  0.116786275726379d0

    alpha_1 = 0.063089014491502
    beta_1  = 0.873821971016996
    e%x_q(4,:) = (/ alpha_1, beta_1, alpha_1 /)
    e%w_q(4)   = 0.050844906370207d0

    alpha_1 = 0.873821971016996d0
    beta_1  = 0.063089014491502d0
    e%x_q(5,:) = (/ alpha_1, beta_1, beta_1 /)
    e%w_q(5)   = 0.050844906370207d0

    alpha_1 = 0.0630890144915021d0
    beta_1  = 0.873821971016996d0
    e%x_q(6,:) = (/ alpha_1, alpha_1, beta_1 /)
    e%w_q(6)   = 0.050844906370207d0

    alpha_1 =  0.636502499121399d0
    beta_1  =  0.053145049844817d0
    gamma_1 =  0.310352451033784d0
    e%x_q(7,:) = (/ alpha_1, beta_1, gamma_1 /)
    e%w_q(7)   = 0.082851075618374d0

    alpha_1 = 0.0531450498448169d0
    beta_1  = 0.310352451033784d0
    gamma_1 = 0.636502499121399d0
    e%x_q(8,:) = (/ alpha_1, beta_1, gamma_1 /)
    e%w_q(8)   = 0.082851075618374d0

    alpha_1 = 0.310352451033784d0
    beta_1  = 0.636502499121399d0
    gamma_1 = 0.053145049844817d0
    e%x_q(9,:) = (/ alpha_1, beta_1, gamma_1 /)
    e%w_q(9)   = 0.082851075618374d0

    alpha_1 = 0.636502499121399d0
    beta_1  = 0.310352451033784d0
    gamma_1 = 0.053145049844817d0
    e%x_q(10,:) = (/ alpha_1, beta_1, gamma_1 /)
    e%w_q(10)   = 0.082851075618374d0

    alpha_1 = 0.053145049844817d0
    beta_1  = 0.636502499121399d0
    gamma_1 = 0.310352451033784d0
    e%x_q(11,:) = (/ alpha_1, beta_1, gamma_1 /)
    e%w_q(11)   = 0.082851075618374d0

    alpha_1 = 0.310352451033784d0
    beta_1  = 0.053145049844817d0
    gamma_1 = 0.636502499121399d0

    e%x_q(12,:) = (/ alpha_1, beta_1, gamma_1 /)
    e%w_q(12)   = 0.082851075618374d0
    !--------------------------------------
