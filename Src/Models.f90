...
!------------------------------------------------------------------------
   ...
   IMPLICIT NONE
    ...
    !====================================
    FUNCTION grad_bl(x, y, nu) RESULT(GG)
    !====================================
      ...
      GG(1) =  -y * (x*c_bl*nu) ** (-0.3D1/0.2D1) * c_bl*nu * &
                exp(-y * (x * c_bl * nu) ** (-0.1D1 / 0.2D1)) / 0.2D1

      GG(2) =  (x*c_bl*nu) ** (-0.1D1 / 0.2D1) * &
               exp(-y * (x*c_bl*nu) ** (-0.1D1 / 0.2D1))


    END FUNCTION grad_bl
    !===================
